...
modelo_bneg2$theta / modelo_bneg2$SE.theta #menor que 1.96 -SEM SUPERDISPERSSÃO
...
#OLS com Box_Cox
library(car)
lambda_BC <- powerTransform(corruption$violtations)
